      ...
      <div className="uk-width-expand">
        <div className="wrap">
          <div className="uk-container ">
            ...
            <div className="uk-grid" uk-grid="" uk-height-match="target: >div > .card1">
              <div className="uk-width-1-2" >
                <div className="uk-card card uk-card-small uk-card-body card1"  >
                  ...
                  <p className="greenhead1">Amount PKR 30,000 (expiry 25 Sep)</p>
                  </div>
                  <p className="uk-margin-remove-bottom">Active agents (27% Consumed)</p>
                  <progress
                    id="js-progressbar "
                    ...
                    max="100"
                  ></progress>
                  <p className="uk-margin-remove-bottom">Conversations (70% Consumed)</p>
                  <progress
                    id="js-progressbar "
                    className=" uk-margin-remove-top uk-progress loader"
                    value="70"
                    max="100"
                  ></progress>
                  <p className="uk-margin-remove-bottom">Active agents (90% Consumed)</p>
                  <progress
                    id="js-progressbar "
                    className=" uk-margin-remove-top uk-progress loader"
                    value="90"
            ...
            <div className="uk-grid" uk-grid="" uk-height-match="target: >div > .uk-card-small">
              ...
              <div className="uk-width-1-4">
                <div className="uk-card card uk-card-small uk-card-body">
                  ...
                  <p className="card2body">
                  Start by adding the Web Widget to your website and connect with customers across the web.                  </p>
                </div>
              </div>
              <div className="uk-width-1-4">
                <div className="uk-card card uk-card-small uk-card-body">
                  ...
                  <p className="card2body">
                  Configure the numbers you will utilize for SMS communications.                  </p>
                </div>
              </div>
            </div>

            <h4 className="card2head">Solutions</h4>
            <div className="uk-grid" uk-height-match="target: > div > .heightMatch">
              <div className="uk-width-1-3">
                <div className="uk-card card uk-card-body heightMatch">
                  <img src={S1} />
                  <p className="card2head">Apply for Broadcast</p>
                  <p className="card2body">Broadcast provides a quick and effortless method to send one-way messages across multiple channels using a unified visual interface.</p>
